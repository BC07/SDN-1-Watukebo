                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="siswaImage" class="form-control @error('siswaImage') is-invalid @enderror" value="{{$siswa->siswaImage}}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="siswaDesc">Deskripsi</label>
                                <textarea name="siswaDesc" class="form-control @error('siswaDesc') is-invalid @enderror" value="{{$siswa->siswaDesc}}">{{$siswa->siswaDesc}}</textarea>
