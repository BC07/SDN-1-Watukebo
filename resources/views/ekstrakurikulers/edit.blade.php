...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <form action="{{ route('ekstrakurikulers.update', [$ekstrakurikulers->id]) }}" method="POST" enctype="multipart/form-data">
                @CSRF
                @method('put')
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="namaEkskul" class="form-control @error('namaEkskul') is-invalid @enderror" value="{{$ekstrakurikulers->namaEkskul}}"></textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="ekskulImage" class="form-control @error('ekskulImage') is-invalid @enderror" value="{{$ekstrakurikulers->ekskulImage}}">
                                <img src="{{ asset('images/ekstrakurikuler/'.$ekstrakurikulers->ekskulImage) }}" width="100px" height="80px" alt="Image">
